...
public class Property extends Searchable {
  ...
  public Value check(String key, Value fallback, String comment) {
    return new Value(yarpJNI.Property_check__SWIG_0_2(swigCPtr, this, key, Value.getCPtr(fallback), fallback, comment), true);
  }

  public Value check(String key, Value fallback) {
    return new Value(yarpJNI.Property_check__SWIG_0_3(swigCPtr, this, key, Value.getCPtr(fallback), fallback), true);
  }
  ...
  public boolean fromConfigDir(String firname, String section, boolean wipe) {
    return yarpJNI.Property_fromConfigDir__SWIG_0(swigCPtr, this, firname, section, wipe);
  }

  public boolean fromConfigDir(String firname, String section) {
    return yarpJNI.Property_fromConfigDir__SWIG_1(swigCPtr, this, firname, section);
  }

  public boolean fromConfigDir(String firname) {
    return yarpJNI.Property_fromConfigDir__SWIG_2(swigCPtr, this, firname);
  }
